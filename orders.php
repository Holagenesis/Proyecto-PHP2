...
<section class="placed-orders">
   ...
   <h1 class="tittle">Pedidos realizados</h1>
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> Hecho el : <span><?php echo $fetch_orders['placed_on']; ?></span> </p>
         ...
         <p> precio : <span>$<?php echo $fetch_orders['total_price']; ?>/-</span> </p>
         <p> estatus de pago : <span style="color:<?php if($fetch_orders['payment_status'] == 'pending'){ echo 'red'; }else{ echo 'green'; } ?>;"><?php echo $fetch_orders['payment_status']; ?></span> </p>
         </div>
      <?php
       }
      }else{
